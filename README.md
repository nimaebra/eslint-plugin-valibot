...
| [prefer-named-schema](docs/rules/prefer-named-schema.md)                           | Prefer passing a named schema variable into Valibot parse-like APIs instead of an inline schema expression. | 🔒   | ✅    |    |
